// --- Extra startup logging for debugging webhook registration ---
console.log('[startup] RESEND_API_KEY is', process.env.RESEND_API_KEY ? 'set' : 'NOT set');
console.log('[startup] NODE_ENV:', process.env.NODE_ENV);
console.log('[startup] Registering webhook route:', !!process.env.RESEND_API_KEY);
...
if (process.env.RESEND_API_KEY) {
  console.log('[webhook] /webhooks/resend route registered');
...
app.listen(PORT, () => {
  console.log('[startup] app.listen called on port', PORT);
