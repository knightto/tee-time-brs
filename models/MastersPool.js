...
const MastersPoolSchema = new mongoose.Schema(
  {
    ...
    tierRules: { type: mongoose.Schema.Types.Mixed, default: () => ({ tierCount: 6, picksPerTier: 1 }) },
    ...
    round1StartsAt: { type: Date, default: null },
    lockOffsetMinutes: { type: Number, default: 120, min: 0 },
